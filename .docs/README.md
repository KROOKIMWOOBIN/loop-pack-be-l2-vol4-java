...
이 문서는 현재 3주차 구현 작업의 문서 지도다. 1/2주차 문서는 과거 참고용으로만 둔다.
...
| 9 | `.codeguide/loopers-2-week.md` | 2주차 설계 legacy reference |
| 10 | `.codeguide/loopers-1-week.md` | 1주차 회원/인증 legacy reference |
| 11 | `.docs/design/01-requirements.md` | 설계 이력 및 요구사항 분석 |
| 12 | `.docs/design/02-sequence-diagrams.md` | 설계 이력 및 시퀀스 다이어그램 |
| 13 | `.docs/design/03-class-diagram.md` | 설계 이력 및 클래스 설계 |
| 14 | `.docs/design/04-erd.md` | 설계 이력 및 ERD |
...
- 현재 구현 기준이 흔들릴 때는 `.codeguide/loopers-3-week.md`를 먼저 본다.
